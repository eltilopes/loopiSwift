//
//  LoopiRadioButtonsController.swift
//  Loopi
//
...
@objc protocol LoopiRadioButtonControllerDelegate {
    /**
...
class LoopiRadioButtonsController : NSObject
{
    fileprivate var buttonsArray = [UIButton]()
    weak var delegate : LoopiRadioButtonControllerDelegate? = nil
    /**
    ...
    init(buttons: UIButton...) {
        ...
        for aButton in buttons {
            aButton.addTarget(self, action: #selector(LoopiRadioButtonsController.pressed(_:)), for: UIControlEvents.touchUpInside)
        }
    ...
    func removeButton(_ aButton: UIButton) {
        ...
        if(iteratingButton != nil) {
            ...
            iteratingButton!.removeTarget(self, action: #selector(LoopiRadioButtonsController.pressed(_:)), for: UIControlEvents.touchUpInside)
