...
class LocationViewController: UICollectionViewController {
    ...
    func updateMovimentacoes(){
        locations.append(LocationFooter( nome : "Buscar Endereco" ,descricao : "" ,imageIconName : "https://firebasestorage.googleapis.com/v0/b/allinone-bd141.appspot.com/o/ic_search_white_24px.svg?alt=media&token=fd135a54-1bcf-4565-96fb-8d1c2955ee89"))
        locations.append(LocationFooter( nome : "Usar Minha Localizacao" ,descricao : "proximo ..." ,imageIconName : "https://firebasestorage.googleapis.com/v0/b/allinone-bd141.appspot.com/o/ic_location_searching_white_24px.svg?alt=media&token=e0de4e4e-db4d-4a01-8573-0c149fa00212"))
        locations.append(LocationFooter( nome : "Casa" ,descricao : "Rua Tallarin. Casa 34. Fortaleza" ,imageIconName : "https://firebasestorage.googleapis.com/v0/b/allinone-bd141.appspot.com/o/ic_home_white_24px.svg?alt=media&token=2946f150-fa7e-4fa6-8a5c-ea9285f9d0f4"))
        locations.append(LocationFooter( nome : "Trabalho" ,descricao : "la la land e mais alguma coisa" ,imageIconName : "https://firebasestorage.googleapis.com/v0/b/allinone-bd141.appspot.com/o/ic_work_white_24px.svg?alt=media&token=055db488-884c-4e1b-9202-9e3ae5d80053"))
    }
